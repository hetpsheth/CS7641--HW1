...
cancer.columns = ['id', 'clumpthickness', 'cellsizeunformity', 'cellshapeuniformity', 'adhesion', 'epithelialsize', 'barenuclei', 'blandchromatin', 'normalnucleoli', 'mitoses', 'class']

cancer = pd.get_dummies(cancer)
cancer.to_hdf('cancer.hdf','cancer',complib='blosc',complevel=9)
