...
madelon = pd.read_hdf('cancer.hdf','cancer')        
madelonX = madelon.drop('class',1).copy().values
madelonY = madelon['class'].copy().values

print (adult.shape, madelon.shape)
...
#
madelon_clf = basicResults(pipeM,madelon_trgX,madelon_trgY,madelon_tstX,madelon_tstY,params_madelon,'ANN','cancer')        
...
pipeM.set_params(**madelon_final_params)
pipeM.set_params(**{'MLP__early_stopping':False})               
iterationLC(pipeM,madelon_trgX,madelon_trgY,madelon_tstX,madelon_tstY,{'MLP__max_iter':[2**x for x in range(12)]+[2100,2200,2300,2400,2500,2600,2700,2800,2900,3000]},'ANN','cancer')        
pipeA.set_params(**adult_final_params)
pipeA.set_params(**{'MLP__early_stopping':False})                  
...
pipeM.set_params(**{'MLP__early_stopping':False})                  
iterationLC(pipeM,madelon_trgX,madelon_trgY,madelon_tstX,madelon_tstY,{'MLP__max_iter':[2**x for x in range(12)]+[2100,2200,2300,2400,2500,2600,2700,2800,2900,3000]},'ANN_OF','cancer')        
